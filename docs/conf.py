...
"""
swpwrx2 documentation build configuration file.
...
#
html_theme_options = {
    "repository_url": "https://github.com/QueriumCorp/swpwrx2",
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'swpwr phase 2 xblock',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'swpwrx2'),
                os.path.join(root_path, 'swpwrx2/migrations')])
