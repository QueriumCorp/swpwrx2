...
VERSION = get_version('swpwrx2', '__init__.py')
...
setup(
    name='swpwrx2',
    version=VERSION,
    description="""swpwr phase 2 xblock""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Querium Corp',
    author_email='kent@querium.com',
    url='https://github.com/QueriumCorp/swpwrx2',
    packages=find_packages(
        include=['swpwrx2', 'swpwrx2.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        'xblock.v1': [
            'swpwrx2 = swpwrx2:Swpwrx2',
        ]
    },
    package_data=package_data("swpwrx2", ["static", "public"]),
